# گزارش اصلاح سخت‌گیرانهٔ نسخهٔ ۳.۲.۰
...
- یکسان‌سازی نسخه روی `3.2.0` در package، lock، App، curriculum، manifest و Android
...
- audit واقعی ساختار MP3 برای ۱۰۹۵ کلیپ: mono/24kHz، بدون duplicate و بدون فایل مفقود
...
- audio: تعداد ۱۰۹۵، duplicate صفر، TTS runtime صفر
