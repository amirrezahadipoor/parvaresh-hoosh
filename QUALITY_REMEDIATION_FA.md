# گزارش اصلاح سخت‌گیرانهٔ نسخهٔ ۳.۳.۱
...
- یکسان‌سازی نسخه روی `3.3.1` در package، lock، App، curriculum، manifest و Android
...
- audit واقعی ساختار MP3 برای ۱۱۰۳ کلیپ: mono/24kHz، بدون duplicate و بدون فایل مفقود
...
- audio: تعداد ۱۱۰۳، duplicate صفر، TTS runtime صفر
