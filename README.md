...
برنامه شامل **۱۹۲ درس و فعالیت تعاملی** در ۶ حوزه بنیادین رشد هوش کودک است:
...
## 🔍 ممیزی محصول و مسیر تجاری

گزارش بی‌رحمانهٔ کیفیت، امتیاز فعلی، گلوگاه‌های رسیدن به ۱۰۰۰ و تحلیل قیمت اشتراک در فایل [`PRODUCT_AUDIT.md`](PRODUCT_AUDIT.md) قرار دارد.
