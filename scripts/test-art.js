...
// نشست ۳: جوجه، گاو، پروانه، زنبور، لاکپشت، پرنده، خرگوش، انار، نان، ستاره، ماه، خورشید
// نشست ۴: کفش، کلاه، پیراهن، تخم، کرم، پیله، گیاه، دانه، بهار، تابستان، پاییز، زمستان
// نشست ۵: چشم، گوش، بینی، زبان، دست، برگ، چوب، کاغذ، سنگ، سکه، قاشق، توت
// نشست ۶: شیر، ماست، موم، شیشه، شکوفه، بادام، سبد، اتو، سوت، مار، میز، باران
const ART_UPGRADED = [
  'گربه', 'سگ', 'ماهی', 'سیب', 'موز', 'گل',
  'درخت', 'توپ', 'کتاب', 'خانه', 'ماشین', 'ابر',
  'پرتقال', 'هویج', 'گیلاس', 'کوه', 'رودخانه', 'برف',
  'چتر', 'ساعت', 'کلید', 'مداد', 'گیره', 'پاک‌کن',
  'جوجه', 'گاو', 'پروانه', 'زنبور', 'لاکپشت', 'پرنده',
  'خرگوش', 'انار', 'نان', 'ستاره', 'ماه', 'خورشید',
  'کفش', 'کلاه', 'پیراهن', 'تخم', 'کرم', 'پیله',
  'گیاه', 'دانه', 'بهار', 'تابستان', 'پاییز', 'زمستان',
  'چشم', 'گوش', 'بینی', 'زبان', 'دست', 'برگ',
  'چوب', 'کاغذ', 'سنگ', 'سکه', 'قاشق', 'توت',
  'شیر', 'ماست', 'موم', 'شیشه', 'شکوفه', 'بادام',
  'سبد', 'اتو', 'سوت', 'مار', 'میز', 'باران',
];
...
for (const name of ART_UPGRADED) {
  ...
  // نشست ۳: کرمِ بدنِ گاو (#F5EBDC) و خطِ دورِ آن (#D9C9AE) — بدنهٔ
  // سفیدِ گاو بدونِ خطِ دور، روی کارتِ سفید محو می‌شد.
  const hasAccent = /#C1352B|#F4B942|#FBE6A2|#F4D03F|#E4572E|#7FD1E8|#B9C4D0|#FFB36B|#FF9642|#F88A5E|#BFE6F5|#EE7452|#96A4B2|#C05A10|#8E1C1C|#D69A1E|#F5EBDC|#D9C9AE/.test(body);
  check(hasHighlight || hasAccent, `«${name}» نه هایلایت دارد نه لهجهٔ پالتِ تازه`);
}

console.log('── نگهبانِ ارتقای هنریِ SVG (§۷.۱۶ آیتم ۷ — نشست‌های پیاپی) ──');
