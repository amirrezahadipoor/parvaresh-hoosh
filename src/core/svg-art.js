...
window.SvgArt = (function() {
    ...
    function object(kind, size) {
        ...
        switch (kind) {
            ...
            case 'bread':
                return wrap(`
                    <path d="M18 56 Q18 32 50 32 Q82 32 82 56 L82 76 Q82 82 76 82 L24 82 Q18 82 18 76 Z"
                        fill="#E3A857" stroke="#2C3A47" stroke-width="2.5" stroke-linejoin="round"/>
                    <path d="M32 44 Q38 36 46 44 M54 44 Q60 36 68 44" fill="none" stroke="#C98B3A" stroke-width="3" stroke-linecap="round"/>
                `, size);

            case 'window':
                return wrap(`
                    <rect x="18" y="16" width="64" height="68" rx="5" fill="#BFE7FF" stroke="#2C3A47" stroke-width="2.8"/>
                    <path d="M50 16 L50 84 M18 50 L82 50" stroke="#2C3A47" stroke-width="2.8"/>
                    <path d="M26 40 L38 28" stroke="#FFF" stroke-width="4" stroke-linecap="round" opacity=".8"/>
                `, size);
            ...
            case 'swing':
                return wrap(`
                    <path d="M14 84 L34 20 L66 20 L86 84" fill="none" stroke="#8B5A2B" stroke-width="4" stroke-linecap="round"/>
                    <path d="M30 20 L74 20" stroke="#8B5A2B" stroke-width="4" stroke-linecap="round"/>
                    <path d="M40 22 L40 62 M60 22 L60 62" stroke="#B2BEC3" stroke-width="3"/>
                    <rect x="34" y="62" width="32" height="9" rx="3" fill="#E74C3C" stroke="#2C3A47" stroke-width="2.2"/>
                `, size);

            case 'mountain':
                return wrap(`
                    <path d="M6 80 L34 30 L52 58 L64 40 L94 80 Z" fill="#7F8C8D" stroke="#2C3A47" stroke-width="2.5" stroke-linejoin="round"/>
                    <path d="M34 30 L44 48 L24 48 Z" fill="#FFF" stroke="#2C3A47" stroke-width="1.8" stroke-linejoin="round"/>
                    <path d="M64 40 L72 52 L56 52 Z" fill="#FFF" stroke="#2C3A47" stroke-width="1.8" stroke-linejoin="round"/>
                    <circle cx="78" cy="24" r="9" fill="#FFD86B" stroke="#2C3A47" stroke-width="2"/>
                `, size);
            ...
            case 'nut':
                return wrap(`
                    <circle cx="50" cy="56" r="28" fill="#C98B3A" stroke="#2C3A47" stroke-width="2.5"/>
                    <path d="M50 28 Q34 42 50 84 Q66 42 50 28 Z" fill="#A96C25" opacity=".55"/>
                    <path d="M50 24 L50 16" stroke="#6B4423" stroke-width="4" stroke-linecap="round"/>
                `, size);

            case 'comb':
                return wrap(`
                    <rect x="14" y="34" width="72" height="18" rx="6" fill="#8E7BFF" stroke="#2C3A47" stroke-width="2.5"/>
                    <path d="M22 52 L22 74 M32 52 L32 74 M42 52 L42 74 M52 52 L52 74 M62 52 L62 74 M72 52 L72 74"
                        stroke="#2C3A47" stroke-width="4" stroke-linecap="round"/>
                `, size);

            case 'racket':
                return wrap(`
                    <ellipse cx="48" cy="36" rx="26" ry="30" fill="#DFF6FF" stroke="#2C3A47" stroke-width="3"/>
                    <path d="M32 20 L64 52 M64 20 L32 52 M48 10 L48 62 M24 36 L72 36" stroke="#9FB8CC" stroke-width="2"/>
                    <path d="M44 66 L38 92" stroke="#E74C3C" stroke-width="8" stroke-linecap="round"/>
                `, size);
            ...
            case 'chocolate':
                return wrap(`
                    <rect x="22" y="26" width="56" height="60" rx="5" fill="#6B4423" stroke="#2C3A47" stroke-width="2.5"/>
                    <path d="M50 26 L50 86 M22 46 L78 46 M22 66 L78 66" stroke="#4A2E15" stroke-width="3"/>
                    <path d="M22 26 L36 14 L92 14 L78 26" fill="#C0392B" stroke="#2C3A47" stroke-width="2.2" stroke-linejoin="round"/>
                `, size);
            ...
            case 'jar':
                return wrap(`
                    <path d="M34 34 L66 34 L72 80 Q72 88 62 88 L38 88 Q28 88 28 80 Z" fill="#7ED6C1" stroke="#2C3A47" stroke-width="2.5" stroke-linejoin="round"/>
                    <rect x="30" y="24" width="40" height="12" rx="4" fill="#48B0F7" stroke="#2C3A47" stroke-width="2.2"/>
                    <path d="M66 44 Q84 48 82 62" fill="none" stroke="#2C3A47" stroke-width="3.5" stroke-linecap="round"/>
                    <path d="M40 52 Q50 46 60 52" fill="none" stroke="#FFF" stroke-width="3" stroke-linecap="round" opacity=".7"/>
                `, size);

            case 'snow':
                return wrap(`
                    <path d="M50 10 L50 90 M14 50 L86 50 M24 24 L76 76 M76 24 L24 76" stroke="#48B0F7" stroke-width="5" stroke-linecap="round"/>
                    <path d="M50 20 L42 28 M50 20 L58 28 M50 80 L42 72 M50 80 L58 72
                             M24 50 L32 42 M24 50 L32 58 M76 50 L68 42 M76 50 L68 58"
                        stroke="#48B0F7" stroke-width="4" stroke-linecap="round"/>
                    <circle cx="50" cy="50" r="7" fill="#BFE7FF" stroke="#48B0F7" stroke-width="2.5"/>
                `, size);

            case 'plate':
                return wrap(`
                    <ellipse cx="50" cy="56" rx="38" ry="28" fill="#EFF3F7" stroke="#2C3A47" stroke-width="2.8"/>
                    <ellipse cx="50" cy="54" rx="24" ry="17" fill="#FFF" stroke="#C7D2DD" stroke-width="2.2"/>
                    <path d="M18 44 Q50 30 82 44" fill="none" stroke="#C7D2DD" stroke-width="2"/>
                `, size);

            case 'rope':
                return wrap(`
                    <path d="M14 70 Q28 40 42 70 T70 70 T94 56" fill="none" stroke="#C98B3A" stroke-width="10" stroke-linecap="round"/>
                    <path d="M14 70 Q28 40 42 70 T70 70 T94 56" fill="none" stroke="#8B5A2B" stroke-width="3" stroke-dasharray="7 8" stroke-linecap="round"/>
                `, size);
            ...
            case 'table':
                return wrap(`
                    <rect x="12" y="38" width="76" height="12" rx="4" fill="#C98B3A" stroke="#2C3A47" stroke-width="2.5"/>
                    <rect x="20" y="50" width="9" height="38" rx="3" fill="#8B5A2B" stroke="#2C3A47" stroke-width="2.2"/>
                    <rect x="71" y="50" width="9" height="38" rx="3" fill="#8B5A2B" stroke="#2C3A47" stroke-width="2.2"/>
                `, size);

            case 'river':
                return wrap(`
                    <path d="M6 88 L26 88 Q34 62 22 40 Q12 22 20 6 L44 6 Q34 24 44 42 Q56 64 48 88 Z"
                        fill="#48B0F7" stroke="#2C3A47" stroke-width="2.2" stroke-linejoin="round"/>
                    <path d="M60 6 L84 6 Q78 26 88 44 Q96 64 92 88 L70 88 Q76 62 66 42 Q58 24 60 6 Z"
                        fill="#6FC6FF" stroke="#2C3A47" stroke-width="2.2" stroke-linejoin="round"/>
                    <path d="M30 30 Q38 26 46 32 M34 58 Q44 54 52 60" fill="none" stroke="#FFF" stroke-width="3" stroke-linecap="round" opacity=".85"/>
                    <path d="M72 24 Q80 20 86 26" fill="none" stroke="#FFF" stroke-width="3" stroke-linecap="round" opacity=".85"/>
                `, size);

            case 'egg':
                return wrap(`
                    <ellipse cx="50" cy="56" rx="26" ry="34" fill="#FFF6E5" stroke="#2C3A47" stroke-width="2.5"/>
                    <ellipse cx="40" cy="42" rx="7" ry="10" fill="#FFF" opacity=".8"/>
                `, size);

            case 'cheese':
                return wrap(`
                    <path d="M14 70 L50 30 L88 44 L88 74 Q88 80 82 80 L20 80 Q14 80 14 74 Z"
                        fill="#FFD35C" stroke="#2C3A47" stroke-width="2.5" stroke-linejoin="round"/>
                    <circle cx="40" cy="62" r="6" fill="#E8B120"/>
                    <circle cx="64" cy="56" r="5" fill="#E8B120"/>
                    <circle cx="72" cy="70" r="4" fill="#E8B120"/>
                `, size);

            case 'soup':
                return wrap(`
                    <ellipse cx="50" cy="50" rx="34" ry="10" fill="#FF8A5C" stroke="#2C3A47" stroke-width="2.5"/>
                    <path d="M16 50 Q18 78 50 78 Q82 78 84 50" fill="#EFF3F7" stroke="#2C3A47" stroke-width="2.5"/>
                    <path d="M40 30 Q44 22 40 14 M56 30 Q60 22 56 14" fill="none" stroke="#B2BEC3" stroke-width="3" stroke-linecap="round"/>
                    <path d="M8 62 L20 62 M80 62 L92 62" stroke="#2C3A47" stroke-width="3" stroke-linecap="round"/>
                `, size);

            case 'wood':
                return wrap(`
                    <rect x="12" y="38" width="76" height="26" rx="8" fill="#C98B3A" stroke="#2C3A47" stroke-width="2.5"/>
                    <ellipse cx="12" cy="51" rx="7" ry="13" fill="#E3B478" stroke="#2C3A47" stroke-width="2.2"/>
                    <ellipse cx="12" cy="51" rx="3.5" ry="7" fill="#A96C25"/>
                    <path d="M34 44 L34 58 M52 42 L52 60 M70 44 L70 58" stroke="#A96C25" stroke-width="2.5" stroke-linecap="round"/>
                `, size);

            case 'water':
                return wrap(`
                    <path d="M50 10 Q78 44 78 60 A28 28 0 0 1 22 60 Q22 44 50 10 Z"
                        fill="#48B0F7" stroke="#2C3A47" stroke-width="2.5" stroke-linejoin="round"/>
                    <path d="M38 56 Q38 70 50 74" fill="none" stroke="#FFF" stroke-width="4" stroke-linecap="round" opacity=".75"/>
                `, size);
            ...
            case 'forest':
                return wrap(`
                    <path d="M24 70 L10 70 L24 46 L18 46 L32 22 L46 46 L40 46 L54 70 Z" fill="#2ED573" stroke="#2C3A47" stroke-width="2.2" stroke-linejoin="round"/>
                    <rect x="28" y="70" width="8" height="16" fill="#8B5A2B" stroke="#2C3A47" stroke-width="2"/>
                    <path d="M62 74 L50 74 L62 54 L57 54 L69 34 L81 54 L76 54 L88 74 Z" fill="#26B65E" stroke="#2C3A47" stroke-width="2.2" stroke-linejoin="round"/>
                    <rect x="65" y="74" width="8" height="12" fill="#8B5A2B" stroke="#2C3A47" stroke-width="2"/>
                `, size);
            ...
            case 'door':
                return wrap(`
                    <rect x="24" y="14" width="52" height="72" rx="5" fill="#C98B3A" stroke="#2C3A47" stroke-width="2.8"/>
                    <rect x="32" y="22" width="36" height="26" rx="3" fill="#A96C25"/>
                    <rect x="32" y="54" width="36" height="24" rx="3" fill="#A96C25"/>
                    <circle cx="64" cy="52" r="4" fill="#FFC048" stroke="#2C3A47" stroke-width="2"/>
                `, size);
            ...
            case 'bell':
                return wrap(`
                    <path d="M28 68 Q28 32 50 26 Q72 32 72 68 Z" fill="#FFC048" stroke="#2C3A47" stroke-width="2.5" stroke-linejoin="round"/>
                    <rect x="22" y="68" width="56" height="9" rx="4" fill="#E8A317" stroke="#2C3A47" stroke-width="2.2"/>
                    <circle cx="50" cy="84" r="7" fill="#8B5A2B" stroke="#2C3A47" stroke-width="2.2"/>
                    <circle cx="50" cy="22" r="5" fill="#8D9AA5" stroke="#2C3A47" stroke-width="2"/>
                `, size);

            case 'earth':
                return wrap(`
                    <circle cx="50" cy="50" r="34" fill="#48B0F7" stroke="#2C3A47" stroke-width="2.5"/>
                    <path d="M26 34 Q40 28 48 38 Q54 48 42 52 Q30 52 26 42 Z" fill="#2ED573" stroke="#2C3A47" stroke-width="1.8"/>
                    <path d="M56 62 Q68 56 76 62 Q78 72 66 76 Q56 74 56 66 Z" fill="#2ED573" stroke="#2C3A47" stroke-width="1.8"/>
                    <path d="M60 26 Q72 28 76 38 Q66 42 60 34 Z" fill="#26B65E" stroke="#2C3A47" stroke-width="1.8"/>
                `, size);

            case 'lemon':
                return wrap(`
                    <ellipse cx="50" cy="56" rx="30" ry="24" fill="#F5E050" stroke="#2C3A47" stroke-width="2.5"/>
                    <path d="M80 50 L88 44 M20 50 L12 44" stroke="#E0C820" stroke-width="5" stroke-linecap="round"/>
                    <path d="M50 30 Q56 22 64 24" fill="none" stroke="#2ED573" stroke-width="4" stroke-linecap="round"/>
                    <ellipse cx="40" cy="46" rx="8" ry="5" fill="#FFF" opacity=".55"/>
                `, size);

            case 'cane':
                return wrap(`
                    <path d="M42 88 L42 40 Q42 18 62 18 Q80 18 80 38" fill="none" stroke="#C98B3A" stroke-width="12" stroke-linecap="round"/>
                    <path d="M42 88 L42 40 Q42 18 62 18 Q80 18 80 38" fill="none" stroke="#8B5A2B" stroke-width="3" stroke-dasharray="8 10" stroke-linecap="round"/>
                `, size);
