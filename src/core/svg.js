...
export const SHAPES = {
  ...
  جوجه: () =>
    svg(`<g><ellipse cx="50" cy="93" rx="20" ry="4.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M42 82 v8 M58 82 v8" stroke="#E4572E" stroke-width="4" stroke-linecap="round"/>
    <path d="M38 91 h8 M54 91 h8" stroke="#E4572E" stroke-width="4" stroke-linecap="round"/>
    <ellipse cx="30" cy="60" rx="7" ry="12" fill="#F3CE55" stroke="#D6A62B" stroke-width="2.4"/>
    ...
    <ellipse cx="50" cy="67" rx="11" ry="8" fill="#FBE6A2"/>
    <path d="M31 56 q5 8 15 7 q-3 6 -11 4 q-6 -5 -4 -11z" fill="#E0A32E" opacity="0.85"/>
    <circle cx="50" cy="34" r="16" fill="#F7DC6F" stroke="#D6A62B" stroke-width="2.8"/>
    <path d="M50 18 q-3 -6 2 -8 q1 5 -2 8" fill="#E09A1E"/>
    <ellipse cx="44" cy="27" rx="7" ry="4.5" fill="#fff" opacity="0.28"/>
    ...
    <circle cx="36.5" cy="38.5" r="2.6" fill="#F88A5E" opacity="0.7"/><circle cx="63.5" cy="38.5" r="2.6" fill="#F88A5E" opacity="0.7"/>
    <path d="M50 38 l-6 4 l6 4 l6 -4 z" fill="#E4572E"/></g>`),

  گاو: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="24" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M36 78 v10 M64 78 v10" stroke="#2D2A32" stroke-width="4" stroke-linecap="round"/>
    <path d="M32 88 h9 M59 88 h9" stroke="#2D2A32" stroke-width="4" stroke-linecap="round"/>
    <ellipse cx="50" cy="58" rx="28" ry="20" fill="#F5EBDC" stroke="#D9C9AE" stroke-width="2.5"/>
    <path d="M31 51 a12 9 0 0 1 13 -8 l-5 17z" fill="#2D2A32"/>
    <ellipse cx="65" cy="65" rx="9" ry="6" fill="#2D2A32"/>
    <path d="M33 43 l-9 -10 l11 3z M67 43 l9 -10 l-11 3z" fill="#D69A1E"/>
    <path d="M29 42 Q22 33 29 29 Q35 35 33 42z" fill="#F7C9C0"/>
    <path d="M71 42 Q78 33 71 29 Q65 35 67 42z" fill="#F7C9C0"/>
    ...
    <circle cx="41.2" cy="46.8" r="1.2" fill="#fff"/><circle cx="61.2" cy="46.8" r="1.2" fill="#fff"/>
    <ellipse cx="46" cy="41" rx="6" ry="3.5" fill="#fff" opacity="0.28"/></g>`),

  پروانه: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="16" ry="3.5" fill="#B9B0A0" opacity="0.25"/>
    <ellipse cx="32" cy="38" rx="17" ry="14" fill="#E4572E"/>
    <ellipse cx="68" cy="38" rx="17" ry="14" fill="#E4572E"/>
    <path d="M20 34 a17 14 0 0 1 21 -10 l-9 20z" fill="#F88A5E"/>
    <path d="M80 34 a17 14 0 0 0 -21 -10 l9 20z" fill="#F88A5E"/>
    <ellipse cx="34" cy="62" rx="13" ry="11" fill="#F4B942"/>
    <ellipse cx="66" cy="62" rx="13" ry="11" fill="#F4B942"/>
    <circle cx="34" cy="62" r="3.4" fill="#8E1C1C"/><circle cx="66" cy="62" r="3.4" fill="#8E1C1C"/>
    <circle cx="27" cy="41" r="3.4" fill="#fff" opacity="0.28"/><circle cx="73" cy="41" r="3.4" fill="#fff" opacity="0.28"/>
    <ellipse cx="50" cy="52" rx="3.5" ry="20" fill="#5A4A3F"/>
    <circle cx="50" cy="29" r="4" fill="#5A4A3F"/>
    <path d="M48 26 Q42 23 36 21 M52 26 Q58 23 64 21" stroke="#5A4A3F" stroke-width="2" fill="none" stroke-linecap="round"/>
    <circle cx="35" cy="20.5" r="2" fill="#8E1C1C"/><circle cx="65" cy="20.5" r="2" fill="#8E1C1C"/></g>`),

  زنبور: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="16" ry="3.5" fill="#B9B0A0" opacity="0.25"/>
    <ellipse cx="38" cy="37" rx="13" ry="9" fill="#BFE6F5" opacity="0.9" stroke="#8FB4CC" stroke-width="1.5"/>
    <ellipse cx="62" cy="37" rx="13" ry="9" fill="#BFE6F5" opacity="0.9" stroke="#8FB4CC" stroke-width="1.5"/>
    <ellipse cx="50" cy="56" rx="22" ry="17" fill="#F4B942"/>
    <path d="M40 42 v28 M52 40 v32" stroke="#2D2A32" stroke-width="6"/>
    <ellipse cx="33" cy="49" rx="5.5" ry="7.5" fill="#fff" opacity="0.28"/>
    <path d="M44 73 l-3 7 M56 73 l3 7" stroke="#2D2A32" stroke-width="2.4" stroke-linecap="round"/>
    <path d="M28 55 l-9 -3" stroke="#2D2A32" stroke-width="3" stroke-linecap="round"/>
    <circle cx="72" cy="52" r="8" fill="#2D2A32"/>
    <circle cx="74.6" cy="49.6" r="2.4" fill="#fff"/></g>`),

  لاکپشت: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="26" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="78" cy="50" r="9" fill="#7CB342"/>
    <circle cx="81" cy="48" r="2.2" fill="#2D2A32"/><circle cx="81.8" cy="47.2" r="0.9" fill="#fff"/>
    <circle cx="74" cy="54" r="1.8" fill="#F4B942" opacity="0.8"/>
    <ellipse cx="32" cy="76" rx="7" ry="5" fill="#7CB342"/><ellipse cx="66" cy="76" rx="7" ry="5" fill="#7CB342"/>
    <ellipse cx="48" cy="80" rx="6" ry="4.5" fill="#7CB342"/>
    <path d="M22 62 l-8 2 l8 4z" fill="#7CB342"/>
    <ellipse cx="50" cy="66" rx="27" ry="12" fill="#D69A1E"/>
    <ellipse cx="50" cy="58" rx="28" ry="20" fill="#4CAF50"/>
    <path d="M50 38 v40 M28 54 h44 M34 44 L66 72 M66 44 L34 72" stroke="#2E7D32" stroke-width="2.5"/>
    <ellipse cx="38" cy="47" rx="9" ry="5" fill="#fff" opacity="0.28"/></g>`),

  پرتقال: () =>
    svg(`<g><ellipse cx="50" cy="86" rx="24" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="50" cy="56" r="27" fill="#F07818"/>
    <path d="M32 70 a27 27 0 0 0 18 13 a25 25 0 0 1 -14 -8 a22 22 0 0 1 -4 -5z" fill="#C05A10" opacity="0.5"/>
  ...
  هویج: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="20" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 84 L36 40 Q50 34 64 40 Z" fill="#F07818"/>
    <path d="M40 52 q-4 4 -3 10 M58 56 q-4 4 -3 10 M45 68 q-3 3 -2 9" stroke="#FFB36B" stroke-width="3" fill="none" stroke-linecap="round" opacity="0.8"/>
  ...
  گیلاس: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="24" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="36" cy="66" r="14" fill="#D42B2B"/><circle cx="64" cy="70" r="13" fill="#E4572E"/>
    <path d="M30 74 a14 14 0 0 0 12 6 a13 13 0 0 1 -8 -4 a10 10 0 0 1 -4 -6z" fill="#8E1C1C" opacity="0.55"/>
    <path d="M58 77 a13 13 0 0 0 10 4 a12 12 0 0 1 -8 -4 a10 10 0 0 1 -2 -5z" fill="#B8431F" opacity="0.55"/>
    <circle cx="31" cy="61" r="4" fill="#fff" opacity="0.5"/>
    <circle cx="59" cy="65" r="3.4" fill="#fff" opacity="0.45"/>
  ...
  کوه: () =>
    svg(`<g><ellipse cx="50" cy="86" rx="36" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M8 80 L34 34 L52 62 L64 44 L92 80 Z" fill="#7B8A99"/>
    <path d="M8 80 L30 46 L52 62 L40 80 Z" fill="#96A4B2"/>
    <path d="M34 34 L44 52 L24 52 Z" fill="#F2F0EC"/>
    <path d="M64 44 L72 56 L56 56 Z" fill="#F2F0EC"/>
    <path d="M8 80 H92" stroke="#5A6B7A" stroke-width="3" stroke-linecap="round"/>
    <path d="M16 72 l3 -3 M20 68 l3 -3" stroke="#C7D2DC" stroke-width="2.4" stroke-linecap="round"/></g>`),

  رودخانه: () =>
    svg(`<g><ellipse cx="42" cy="90" rx="30" ry="5" fill="#B9B0A0" opacity="0.25"/>
    <path d="M20 20 Q46 40 30 58 Q14 76 40 88" stroke="#1B6B8F" stroke-width="18" fill="none" stroke-linecap="round"/>
    ...
    <path d="M24 28 Q40 42 30 54" stroke="#BFE6F5" stroke-width="2.6" fill="none" stroke-linecap="round" opacity="0.8"/>
    ...
    <circle cx="63" cy="38" r="2" fill="#E4572E"/></g>`),
  ...
  برف: () =>
    ...
    <path d="M70 39 l10 1 M70 39 l-1 -10 M30 61 l-10 -1 M30 61 l1 10"/>
    <g fill="#7FD1E8" opacity="0.8"><circle cx="20" cy="33" r="2.6"/><circle cx="80" cy="33" r="2.6"/><circle cx="20" cy="67" r="2.6"/><circle cx="80" cy="67" r="2.6"/></g>
    <ellipse cx="50" cy="90" rx="18" ry="4" fill="#B9B0A0" opacity="0.22"/></g>`),

  چتر: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="26" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M12 54 Q50 12 88 54 Z" fill="#E4572E"/>
    <path d="M12 54 Q22 44 32 54 Q42 44 50 54 Q58 44 68 54 Q78 44 88 54" fill="#C8431F"/>
    <path d="M30 34 Q50 18 70 34 Q52 28 30 34 Z" fill="#F88A5E" opacity="0.55"/>
    <path d="M50 54 v26 Q50 90 38 88" stroke="#6B4423" stroke-width="4" fill="none" stroke-linecap="round"/>
    <circle cx="40" cy="90" r="2.2" fill="#7FBBD6"/></g>`),

  ساعت: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="26" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="50" cy="54" r="30" fill="#F2F0EC" stroke="#2D2A32" stroke-width="4"/>
    ...
    <path d="M36 20 L30 12 M64 20 L70 12" stroke="#2D2A32" stroke-width="4" stroke-linecap="round"/>
    <path d="M30 40 a30 30 0 0 1 14 -14" stroke="#fff" stroke-width="4" fill="none" stroke-linecap="round" opacity="0.55"/></g>`),

  کلید: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="30" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="32" cy="46" r="16" fill="none" stroke="#F4B942" stroke-width="8"/>
    <path d="M22 40 a16 16 0 0 0 10 22" fill="none" stroke="#D69A1E" stroke-width="3" stroke-linecap="round" opacity="0.7"/>
  ...
  مداد: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="18" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M40 72 L50 88 L60 72 Z" fill="#E8C39E" stroke="#C49A6C" stroke-width="2.4" stroke-linejoin="round"/>
    ...
    <path d="M47 78 l2 -3" stroke="#C49A6C" stroke-width="2" stroke-linecap="round"/></g>`),

  گیره: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="22" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M38 22 v46 a12 12 0 0 0 24 0 v-38 a7 7 0 0 0 -14 0 v36"
      fill="none" stroke="#7B8794" stroke-width="7" stroke-linecap="round"/>
    <path d="M38 22 v46 a12 12 0 0 0 24 0 v-38 a7 7 0 0 0 -14 0 v36"
      fill="none" stroke="#B9C4D0" stroke-width="2.2" stroke-linecap="round" opacity="0.8"/></g>`),

  'پاک‌کن': () =>
    svg(`<g><ellipse cx="50" cy="86" rx="24" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <rect x="30" y="34" width="40" height="34" rx="5" fill="#E4572E" stroke="#B8431F" stroke-width="2.8"/>
    <path d="M35 34 h7 v34 h-7z" fill="#EE7452"/>
    <path d="M30 46 h40" stroke="#B8431F" stroke-width="2.4"/>
    <rect x="37" y="37" width="18" height="5" rx="2.5" fill="#fff" opacity="0.4"/>
    <path d="M35 34 h30 a5 5 0 0 1 5 5 v7 h-40 v-7 a5 5 0 0 1 5 -5z" fill="#F2F0EC" stroke="#B8431F" stroke-width="2.8"/>`),

  گربه: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="30" ry="7" fill="#B9B0A0" opacity="0.28"/>
    <ellipse cx="50" cy="62" rx="26" ry="24" fill="#F4A259"/>
    <ellipse cx="42" cy="71" rx="12" ry="9" fill="#F7C9A0"/>
    ...
    <ellipse cx="38" cy="50" rx="10" ry="7" fill="#fff" opacity="0.30"/>
  ...
  سگ: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="30" ry="7" fill="#B9B0A0" opacity="0.28"/>
    <ellipse cx="50" cy="60" rx="26" ry="24" fill="#B5835A"/>
    ...
    <path d="M50 70 v5 M44 78 Q50 82 56 78" stroke="#2D2A32" stroke-width="2" fill="none" stroke-linecap="round"/>
    <path d="M31 62 h13 l-2.4 7 h-8.6 z" fill="#E4572E"/></g>`),

  ماهی: () =>
    svg(`<g><ellipse cx="50" cy="78" rx="32" ry="6" fill="#B9B0A0" opacity="0.25"/>
    <ellipse cx="46" cy="50" rx="30" ry="20" fill="#2E86AB"/>
    <ellipse cx="36" cy="40" rx="12" ry="7" fill="#fff" opacity="0.28"/>
    ...
    <path d="M66 44 Q72 50 66 56" stroke="#7FD1E8" stroke-width="3" fill="none" stroke-linecap="round"/>
    <path d="M60 52 Q68 60 60 68" stroke="#1B6B8F" stroke-width="2.4" fill="none" stroke-linecap="round"/></g>`),

  پرنده: () =>
    svg(`<g><ellipse cx="54" cy="88" rx="24" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M46 76 v9 M58 76 v9" stroke="#E4572E" stroke-width="3" stroke-linecap="round"/>
    <path d="M43 85 h7 M54 85 h7" stroke="#E4572E" stroke-width="3" stroke-linecap="round"/>
    <path d="M74 62 L92 56 L88 70 Z" fill="#E0A32E"/>
    <path d="M80 63 L90 59 L87 68 Z" fill="#D69A1E"/>
    <ellipse cx="52" cy="56" rx="24" ry="20" fill="#F4B942"/>
    <ellipse cx="48" cy="68" rx="13" ry="9" fill="#7FD1E8"/>
    <path d="M52 52 Q66 44 74 58 Q62 62 52 52 Z" fill="#E0A32E"/>
    <circle cx="34" cy="42" r="14" fill="#F4B942"/>
    <ellipse cx="30" cy="35" rx="6" ry="4" fill="#fff" opacity="0.28"/>
    <circle cx="32" cy="39" r="3.6" fill="#2D2A32"/><circle cx="33" cy="38" r="1.3" fill="#fff"/>
    <path d="M24 42 l-12 4 12 4 z" fill="#E4572E"/>
    <path d="M27 49 q3 3 6 1" stroke="#2D2A32" stroke-width="1.6" fill="none" stroke-linecap="round"/></g>`),

  خرگوش: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <ellipse cx="40" cy="30" rx="7" ry="20" fill="#EDEDED" stroke="#B9B4B0" stroke-width="2.6"/>
    ...
    <ellipse cx="41" cy="57" rx="7" ry="5" fill="#fff" opacity="0.28"/>
    ...
    <path d="M26 68 h-9 M27 73 l-8 3 M74 68 h9 M73 73 l8 3" stroke="#B9C4D0" stroke-width="1.8" stroke-linecap="round"/>
    <path d="M76 84 l6 -15 5 2 -4 16z" fill="#E4572E"/>
    <path d="M80 69 q1 -8 8 -8 q-3 6 -5 9z" fill="#4CAF50"/></g>`),

  // ── میوه‌ها ───────────────────────────────────────────────────────────
  سیب: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="22" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 30 C30 30 22 46 26 62 C30 78 42 86 50 86 C58 86 70 78 74 62 C78 46 70 30 50 30 Z" fill="#E4572E"/>
    <path d="M50 32 V20" stroke="#6B4423" stroke-width="4" stroke-linecap="round"/>
    <path d="M52 24 Q66 14 70 26 Q58 32 52 24 Z" fill="#4CAF50"/>
    <ellipse cx="38" cy="48" rx="5" ry="8" fill="#fff" opacity=".35"/>
    <ellipse cx="60" cy="70" rx="6" ry="9" fill="#C1352B" opacity=".5"/></g>`),

  موز: () =>
    svg(`<g><ellipse cx="52" cy="84" rx="26" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M22 32 Q26 70 62 78 Q84 80 86 62 Q70 70 52 58 Q34 46 34 30 Z" fill="#F4B942"/>
    <path d="M22 32 Q26 70 62 78" stroke="#D89B1E" stroke-width="2.5" fill="none"/>
    <path d="M40 40 Q44 62 64 72" stroke="#FBE6A2" stroke-width="5" fill="none" stroke-linecap="round" opacity=".8"/>
    <path d="M20 28 l6 6" stroke="#6B4423" stroke-width="4" stroke-linecap="round"/></g>`),

  انار: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="23" ry="5.5" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="50" cy="58" r="27" fill="#C1352B"/>
    <path d="M26 62 a27 27 0 0 0 21 22 a25 25 0 0 1 -17 -9 a24 24 0 0 1 -4 -13z" fill="#8E1C1C" opacity="0.55"/>
    <path d="M50 31 v-9 M50 22 l-6 -6 M50 22 l6 -6" stroke="#6B4423" stroke-width="3.5" stroke-linecap="round" fill="none"/>
    <path d="M44 26 q6 4 12 0 l-2 6 q-4 2 -8 0z" fill="#8E1C1C"/>
    <ellipse cx="40" cy="46" rx="6" ry="9" fill="#fff" opacity="0.30"/>
  ...
  گل: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="20" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 62 V88" stroke="#4CAF50" stroke-width="4" stroke-linecap="round"/>
    ...
    <g fill="#C1352B" opacity="0.45"><ellipse cx="50" cy="34" rx="4.5" ry="7"/><ellipse cx="50" cy="62" rx="4.5" ry="7"/>
    <ellipse cx="36" cy="48" rx="7" ry="4.5"/><ellipse cx="64" cy="48" rx="7" ry="4.5"/></g>
    <circle cx="50" cy="48" r="8" fill="#F4B942"/>
    <circle cx="50" cy="48" r="3.4" fill="#E08A1E"/></g>`),

  درخت: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="30" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <rect x="45" y="56" width="10" height="32" rx="3" fill="#8B5E3C" stroke="#6B462B" stroke-width="2.4"/>
    ...
    <circle cx="30" cy="36" r="3" fill="#E4572E"/><circle cx="62" cy="28" r="3" fill="#E4572E"/>
    <circle cx="44" cy="56" r="3" fill="#E4572E"/><circle cx="66" cy="58" r="3" fill="#E4572E"/></g>`),

  // ── اشیاء ─────────────────────────────────────────────────────────────
  توپ: () =>
    svg(`<g><ellipse cx="50" cy="86" rx="24" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="50" cy="54" r="28" fill="#E4572E"/>
    ...
    <circle cx="40" cy="42" r="6" fill="#fff" opacity="0.35"/>
    <path d="M28 54 a22 22 0 0 1 6 -13" stroke="#C1352B" stroke-width="3.5" fill="none" opacity="0.55"/></g>`),

  کتاب: () =>
    svg(`<g><ellipse cx="50" cy="84" rx="34" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M18 26 H48 V78 H18 Z" fill="#E4572E"/><path d="M52 26 H82 V78 H52 Z" fill="#C1352B"/>
    ...
    <path d="M58 38 H76 M58 46 H76 M58 54 H72" stroke="#fff" stroke-width="2.6" stroke-linecap="round"/>
    <path d="M76 24 l6 4 v14 l-6 -4 z" fill="#F4B942"/></g>`),

  خانه: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="36" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <rect x="22" y="50" width="56" height="36" fill="#F7E4C8" stroke="#C9A87C" stroke-width="2.8"/>
    ...
    <path d="M40 30 l3 2.5 h-6 z" fill="#fff" opacity="0.5"/></g>`),

  ماشین: () =>
    svg(`<g><ellipse cx="50" cy="86" rx="38" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M14 62 L20 44 H70 L82 62 Z" fill="#2E86AB" stroke="#1B6B8F" stroke-width="2.8" stroke-linejoin="round"/>
    ...
    <path d="M24 44 l-4 6" stroke="#F4D03F" stroke-width="3" stroke-linecap="round"/>
    <path d="M38 40 l4 3" stroke="#BFE6F5" stroke-width="2.6" stroke-linecap="round" opacity="0.8"/></g>`),

  ستاره: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="17" ry="4" fill="#B9B0A0" opacity="0.25"/>
    <path d="M50 16 L60 42 L88 44 L66 62 L73 88 L50 73 L27 88 L34 62 L12 44 L40 42 Z"
    ...
    <ellipse cx="43" cy="40" rx="7" ry="5" fill="#fff" opacity="0.28"/>
    <circle cx="15" cy="22" r="2.5" fill="#FBE6A2"/><circle cx="87" cy="80" r="3" fill="#FBE6A2"/>
    <circle cx="83" cy="16" r="2" fill="#FBE6A2"/></g>`),

  // هلال ماه با «تفریق» دو دایره ساخته می‌شود. تلاش اول با یک path و دو
  // کمان، به‌خاطر جهت‌های sweep، شکل توخالی و نامرئی می‌داد.
  ماه: () =>
    svg(`<g><ellipse cx="54" cy="90" rx="15" ry="3.5" fill="#B9B0A0" opacity="0.25"/>
    <path d="M62 16 a36 36 0 1 0 22 62 a30 30 0 1 1 -22 -62z"
      fill="#F4B942" stroke="#D69A1E" stroke-width="3" stroke-linejoin="round"/>
    <circle cx="52" cy="40" r="4.5" fill="#E8AC2E"/>
    <circle cx="44" cy="58" r="6" fill="#E8AC2E"/>
    <circle cx="58" cy="66" r="3.5" fill="#E8AC2E"/>
    <ellipse cx="40" cy="34" rx="4" ry="7" fill="#fff" opacity="0.28"/>
    <circle cx="80" cy="30" r="2.5" fill="#FBE6A2"/><circle cx="88" cy="44" r="2" fill="#FBE6A2"/></g>`),

  خورشید: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="16" ry="4" fill="#B9B0A0" opacity="0.25"/>
    <g stroke-linecap="round" stroke-width="5">
    <path d="M50 14 V5 M50 86 v9 M14 50 H5 M86 50 h9 M23 23 l-6.5 -6.5 M77 77 l6.5 6.5 M77 23 l6.5 -6.5 M23 77 l-6.5 6.5" stroke="#FFB36B"/>
    <path d="M50 24 V15 M50 76 v9 M24 50 H15 M76 50 h9" stroke="#F4B942"/></g>
    <circle cx="50" cy="50" r="23" fill="#F4B942" stroke="#D69A1E" stroke-width="3"/>
    <ellipse cx="42" cy="41" rx="7" ry="5" fill="#fff" opacity="0.28"/>
    <circle cx="24" cy="82" r="2.5" fill="#FBE6A2"/><circle cx="79" cy="18" r="2" fill="#FBE6A2"/></g>`),

  ابر: () =>
    svg(`<g><ellipse cx="50" cy="82" rx="34" ry="7" fill="#B9B0A0" opacity="0.25"/>
    <path d="M28 68 a16 16 0 0 1 4 -30 a20 20 0 0 1 38 -2 a15 15 0 0 1 2 32z"
    ...
    <path d="M44 62 a10 10 0 0 1 14 -2" fill="none" stroke="#FFF" stroke-width="3" stroke-linecap="round" opacity=".55"/></g>`),
...
// بازی کند. هر آیتمی که در درسی می‌آید باید تصویر داشته باشد.
  ...
  کفش: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="36" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M12 70 q0 -8 8 -9 l16 -2 q6 -1 10 -6 l10 -12 q4 -5 10 -3 q7 2 8 10
      l2 14 q1 8 9 10 q7 2 7 8 v4 h-80 z"
      fill="#3D6FA8" stroke="#274F79" stroke-width="2.6" stroke-linejoin="round"/>
    <ellipse cx="34" cy="58" rx="10" ry="6" fill="#fff" opacity="0.28"/>
    <path d="M10 78 h82 q3 0 3 4 t-3 4 h-82 q-3 0 -3 -4 t3 -4z" fill="#2B2A33"/>
    <path d="M12 82 h78" stroke="#4A4A55" stroke-width="1.6" stroke-linecap="round"/>
    ...
    <path d="M16 64 l-6 3 6 4z" fill="#F4D03F"/></g>`),


  کلاه: () =>
    svg(`<g><ellipse cx="50" cy="74" rx="34" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M28 56 q0 -30 22 -30 t22 30 z" fill="#E4572E" stroke="#C04521" stroke-width="2.5"/>
    <ellipse cx="41" cy="38" rx="8" ry="10" fill="#fff" opacity="0.28"/>
    <path d="M34 46 q16 8 32 0" fill="none" stroke="#C04521" stroke-width="2" stroke-linecap="round"/>
    ...
    <circle cx="50" cy="24" r="2" fill="#FBE6A2"/></g>`),

  پیراهن: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="28" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M34 22 h32 l18 12 -10 14 -6 -4 v40 h-36 v-40 l-6 4 -10 -14 z"
    ...
    <ellipse cx="38" cy="40" rx="7" ry="10" fill="#fff" opacity="0.28"/>
    <path d="M38 26 l-8 6 4 6 M62 26 l8 6 -4 6" fill="none" stroke="#F4D03F" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M32 80 h36" stroke="#2E7A3D" stroke-width="2" stroke-linecap="round"/>
    <circle cx="50" cy="46" r="2.6" fill="#2E7A3D"/>
    <circle cx="50" cy="58" r="2.6" fill="#2E7A3D"/></g>`),
  ...
  تخم: () =>
    svg(`<g><ellipse cx="50" cy="84" rx="36" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M10 70 q40 -22 80 0 q-40 16 -80 0z" fill="#8FCB6B" stroke="#69A64E" stroke-width="2.4" stroke-linejoin="round"/>
    <path d="M16 68 q34 -16 68 0" fill="none" stroke="#69A64E" stroke-width="1.6" opacity="0.6"/>
    ...
    <ellipse cx="44" cy="32" rx="5" ry="7" fill="#fff" opacity="0.30"/>
    <circle cx="55" cy="48" r="2" fill="#FF9642" opacity="0.7"/><circle cx="46" cy="55" r="1.7" fill="#FF9642" opacity="0.7"/></g>`),

  کرم: () =>
    svg(`<g><ellipse cx="50" cy="72" rx="32" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="26" cy="56" r="11" fill="#8FCB6B"/>
    <circle cx="42" cy="58" r="12" fill="#7DBB5B"/>
    <circle cx="58" cy="58" r="12" fill="#8FCB6B"/>
    <circle cx="74" cy="56" r="11" fill="#7DBB5B"/>
    <ellipse cx="38" cy="50" rx="6" ry="4" fill="#fff" opacity="0.28"/>
    <ellipse cx="54" cy="50" rx="6" ry="4" fill="#fff" opacity="0.28"/>
    <circle cx="21" cy="61" r="2.4" fill="#F88A5E" opacity="0.8"/><circle cx="31" cy="63" r="2.4" fill="#F88A5E" opacity="0.8"/>
    <circle cx="79" cy="52" r="3" fill="#2D2A32"/><circle cx="80" cy="51" r="1.1" fill="#fff"/>
    <circle cx="70" cy="47" r="2" fill="#F88A5E" opacity="0.8"/>
    <path d="M74 44 v-6 M82 46 v-5" stroke="#2D2A32" stroke-width="2.5" stroke-linecap="round"/>
    <circle cx="74" cy="37" r="2" fill="#E4572E"/><circle cx="82" cy="40" r="2" fill="#E4572E"/>
    <path d="M76 58 q3 2 5 0" stroke="#2D2A32" stroke-width="1.8" fill="none" stroke-linecap="round"/></g>`),

  پیله: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="20" ry="4.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 10 v10" stroke="#D69A1E" stroke-width="2" stroke-linecap="round"/>
    <path d="M40 20 h20 v4 h-20 z" fill="#8B6F47"/>
    <path d="M50 24 q22 10 22 32 t-22 30 q-22 -8 -22 -30 t22 -32 z" fill="#C89B5A" stroke="#A87B3A" stroke-width="2"/>
    <ellipse cx="41" cy="46" rx="6" ry="12" fill="#fff" opacity="0.28"/>
    <path d="M36 44 q14 6 28 0 M34 58 q16 7 32 0 M38 72 q12 5 24 0" fill="none" stroke="#A87B3A" stroke-width="2"/>
    <path d="M44 34 q6 2 12 0 M46 80 q4 2 8 0" fill="none" stroke="#D69A1E" stroke-width="2" stroke-linecap="round"/></g>`),

  گیاه: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="26" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 86 v-40" stroke="#3D9A50" stroke-width="5" stroke-linecap="round"/>
    <path d="M50 58 q-20 -6 -22 -22 q18 0 22 22z" fill="#6FBF73"/>
    <path d="M50 50 q20 -6 22 -22 q-18 0 -22 22z" fill="#8FCB6B"/>
    <ellipse cx="62" cy="36" rx="6" ry="4" fill="#fff" opacity="0.30" transform="rotate(-24 62 36)"/>
    <ellipse cx="36" cy="44" rx="5" ry="3.5" fill="#fff" opacity="0.28" transform="rotate(28 36 44)"/>
    <path d="M26 84 q24 8 48 0 l2 5 q-26 8 -52 0z" fill="#C05A10" opacity="0.55"/>
    <path d="M28 86 h44" stroke="#8B6F47" stroke-width="6" stroke-linecap="round"/></g>`),

  دانه: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="27" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M22 78 h56 l-4 10 h-48 z" fill="#8B6F47"/>
    <path d="M22 84 q28 6 56 0" fill="none" stroke="#C05A10" stroke-width="2" opacity="0.5"/>
    <ellipse cx="50" cy="60" rx="10" ry="13" fill="#C89B5A" stroke="#8B6F47" stroke-width="2.5"/>
    <ellipse cx="46" cy="55" rx="3.5" ry="5.5" fill="#fff" opacity="0.30"/>
    <path d="M50 52 q4 -6 0 -10" fill="none" stroke="#3D9A50" stroke-width="3" stroke-linecap="round"/>
    <path d="M68 30 q5 7 0 10 q-5 -3 0 -10z" fill="#7FD1E8"/>
    <path d="M68 42 v6" stroke="#7FD1E8" stroke-width="2.4" stroke-linecap="round"/></g>`),

  // فصل‌ها — هرکدام نشانهٔ دیداری یکتا دارد، نه فقط رنگ متفاوت
  بهار: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="4.5" fill="#B9B0A0" opacity="0.25"/>
    <circle cx="50" cy="50" r="36" fill="#E2F2D8" stroke="#A8CE97" stroke-width="3"/>
    <path d="M28 28 a36 36 0 0 1 20 -13" fill="none" stroke="#fff" stroke-width="4" stroke-linecap="round" opacity="0.55"/>
    <path d="M50 82 v-26" stroke="#3D9A50" stroke-width="4" stroke-linecap="round"/>
    <path d="M50 76 q-9 -3 -10 -12 q9 0 10 12z" fill="#8FCB6B"/>
    ...
    <circle cx="80" cy="64" r="2.4" fill="#FBE6A2"/><circle cx="22" cy="64" r="2" fill="#FBE6A2"/></g>`),

  تابستان: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="4.5" fill="#B9B0A0" opacity="0.25"/>
    <circle cx="50" cy="50" r="36" fill="#FFEDC2" stroke="#E0B978" stroke-width="3"/>
    <g stroke="#FFB36B" stroke-width="4" stroke-linecap="round">
    <path d="M50 24 v-6"/><path d="M50 76 v6"/><path d="M24 50 h-6"/><path d="M76 50 h6"/>
    <path d="M33 33 l-4 -4"/><path d="M67 33 l4 -4"/><path d="M33 67 l-4 4"/><path d="M67 67 l4 4"/></g>
    <g stroke="#F07818" stroke-width="4" stroke-linecap="round">
    <path d="M50 30 v-4"/><path d="M50 70 v4"/><path d="M30 50 h-4"/><path d="M70 50 h4"/></g>
    <circle cx="50" cy="50" r="17" fill="#F4B942"/>
    <ellipse cx="44" cy="44" rx="6" ry="4.5" fill="#fff" opacity="0.30"/>
    <circle cx="50" cy="50" r="4" fill="#F4D03F" opacity="0.8"/>
    <path d="M26 66 q6 4 12 2" fill="none" stroke="#7FD1E8" stroke-width="3" stroke-linecap="round"/></g>`),

  پاییز: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="4.5" fill="#B9B0A0" opacity="0.25"/>
    <circle cx="50" cy="50" r="36" fill="#F8E1C6" stroke="#D2A87E" stroke-width="3"/>
    <path d="M28 28 a36 36 0 0 1 20 -13" fill="none" stroke="#fff" stroke-width="4" stroke-linecap="round" opacity="0.5"/>
    ...
    <path d="M24 46 q4 4 2 8" fill="none" stroke="#D69A1E" stroke-width="2" stroke-linecap="round"/>
    <circle cx="30" cy="70" r="1.8" fill="#D69A1E" opacity="0.8"/><circle cx="74" cy="46" r="1.8" fill="#D69A1E" opacity="0.8"/></g>`),

  زمستان: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="4.5" fill="#B9B0A0" opacity="0.25"/>
    <circle cx="50" cy="50" r="36" fill="#D9EAF4" stroke="#8FB4CC" stroke-width="3"/>
    <path d="M28 28 a36 36 0 0 1 20 -13" fill="none" stroke="#fff" stroke-width="4" stroke-linecap="round" opacity="0.6"/>
    ...
    <circle cx="26" cy="28" r="2.2" fill="#BFE6F5"/><circle cx="76" cy="68" r="2.6" fill="#BFE6F5"/>
    <circle cx="70" cy="26" r="1.8" fill="#BFE6F5"/><circle cx="30" cy="72" r="1.8" fill="#BFE6F5"/></g>`),

  // حواس پنج‌گانه — اندام، نه نماد انتزاعی
  چشم: () =>
    svg(`<g><ellipse cx="50" cy="86" rx="30" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M12 50 q38 -30 76 0 q-38 30 -76 0z" fill="#FFF" stroke="#2B2A33" stroke-width="3"/>
    <circle cx="50" cy="50" r="15" fill="#5AA9CF"/>
    <path d="M50 35 a15 15 0 0 1 0 30 a11 15 0 0 0 0 -30z" fill="#7FD1E8" opacity="0.6"/>
    <circle cx="50" cy="50" r="7" fill="#2B2A33"/>
    <circle cx="45" cy="45" r="3" fill="#FFF"/><circle cx="55" cy="55" r="1.6" fill="#FFF"/>
    <ellipse cx="50" cy="38" rx="9" ry="4" fill="#fff" opacity="0.28"/>
    <path d="M26 36 l-5 -8 M40 28 l-3 -9 M60 28 l3 -9 M74 36 l5 -8" stroke="#2B2A33" stroke-width="2.6" stroke-linecap="round"/></g>`),

  گوش: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="26" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M62 18 q-30 -4 -32 26 q-1 20 6 30 q5 8 12 8 q8 0 8 -9 q0 -8 6 -12 q14 -9 12 -25 q-2 -16 -12 -18z"
      fill="#F7C9A8" stroke="#C99B7A" stroke-width="3" stroke-linejoin="round"/>
    <ellipse cx="44" cy="40" rx="5" ry="10" fill="#fff" opacity="0.28"/>
    <path d="M56 38 q-12 2 -10 16 q1 8 6 10" fill="none" stroke="#C99B7A" stroke-width="3.5" stroke-linecap="round"/>
    <path d="M60 60 q4 4 1 9" fill="none" stroke="#C99B7A" stroke-width="2.6" stroke-linecap="round"/>
    <ellipse cx="55" cy="82" rx="3" ry="2.2" fill="#B07B5A" opacity="0.7"/></g>`),

  // ⚠ نسخهٔ اول نیم‌رخ بود و مثل یک سیم خمیده دیده می‌شد. بینیِ
  // روبه‌رو با دو سوراخ برای کودک بلافاصله خواناست.
  بینی: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 16 q-16 26 -22 46 q-4 14 10 18 q12 4 12 -6 q0 10 12 6 q14 -4 10 -18 q-6 -20 -22 -46z"
      fill="#F7C9A8" stroke="#C99B7A" stroke-width="3" stroke-linejoin="round"/>
    ...
    <ellipse cx="42" cy="38" rx="6" ry="12" fill="#fff" opacity="0.28"/></g>`),

  // ⚠ نسخهٔ اول مثل کاسهٔ صورتی بود. حالا دهانِ باز با دندان‌های
  // بالا و زبانِ بیرون‌آمده — نشانهٔ روشنِ «چشیدن».
  زبان: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="28" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M18 40 q32 -20 64 0 q2 26 -14 38 q-18 14 -36 0 q-16 -12 -14 -38z"
      fill="#8E3B4E"/>
    ...
    <ellipse cx="44" cy="62" rx="6" ry="9" fill="#fff" opacity="0.28"/>
    <path d="M50 62 v18" fill="none" stroke="#C4566F" stroke-width="2.5" stroke-linecap="round"/>
    <circle cx="40" cy="70" r="1.4" fill="#C4566F" opacity="0.7"/><circle cx="60" cy="68" r="1.4" fill="#C4566F" opacity="0.7"/></g>`),

  دست: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="24" ry="4.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M34 88 v-30 q-8 2 -10 -6 q-2 -8 6 -10 l4 -1 v-24 q0 -6 6 -6 t6 6 v20 h3 v-26 q0 -6 6 -6 t6 6 v26 h3 v-20 q0 -6 6 -6 t6 6 v34 q0 24 -18 37z"
      fill="#F7C9A8" stroke="#C99B7A" stroke-width="3" stroke-linejoin="round"/>
    <ellipse cx="50" cy="62" rx="10" ry="14" fill="#fff" opacity="0.28"/>
    <rect x="30" y="85" width="40" height="9" rx="4.5" fill="#7FD1E8"/>
    <path d="M34 89.5 q16 5 32 0" fill="none" stroke="#5FB6D8" stroke-width="2" stroke-linecap="round"/></g>`),
  ...
  برگ: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="30" ry="5.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M78 20 q-52 4 -60 40 q-4 20 10 26 q26 10 42 -14 q14 -22 8 -52z"
    ...
    <ellipse cx="52" cy="38" rx="9" ry="6" fill="#fff" opacity="0.28" transform="rotate(-36 52 38)"/>
    <path d="M64 60 q6 -7 13 -5 q-2 9 -11 8 q-3 -1 -2 -3z" fill="#7FD1E8"/></g>`),

  چوب: () =>
    svg(`<g><ellipse cx="50" cy="70" rx="38" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <rect x="14" y="40" width="72" height="22" rx="10" fill="#C89B5A" stroke="#8B6F47" stroke-width="3"/>
    <ellipse cx="82" cy="51" rx="6" ry="11" fill="#A87B3A"/>
    <ellipse cx="82" cy="51" rx="3.5" ry="6.5" fill="#D69A1E" opacity="0.8"/>
    <path d="M28 46 v10 M42 44 v14 M56 46 v10" stroke="#A87B3A" stroke-width="2.5" stroke-linecap="round"/>
    <ellipse cx="30" cy="44" rx="9" ry="3.4" fill="#fff" opacity="0.28"/>
    <path d="M62 56 q10 3 18 0" fill="none" stroke="#8B6F47" stroke-width="2" stroke-linecap="round" opacity="0.7"/></g>`),

  کاغذ: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="27" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M24 14 h40 l14 14 v58 h-54z" fill="#FFF" stroke="#B9AFA0" stroke-width="3" stroke-linejoin="round"/>
    <path d="M64 14 v14 h14" fill="none" stroke="#B9AFA0" stroke-width="3" stroke-linejoin="round"/>
    <path d="M64 28 l14 -14 v14z" fill="#FBE6A2" opacity="0.6"/>
    <rect x="31" y="40" width="40" height="7" rx="3.5" fill="#FFB36B" opacity="0.55"/>
    <path d="M34 56 h34 M34 68 h22" stroke="#C9BFB0" stroke-width="3.5" stroke-linecap="round"/>
    <ellipse cx="38" cy="22" rx="8" ry="4" fill="#fff" opacity="0.28"/></g>`),

  سنگ: () =>
    svg(`<g><ellipse cx="50" cy="82" rx="34" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <path d="M18 72 q-4 -22 16 -32 q22 -12 38 2 q16 12 10 30 q-32 8 -64 0z"
      fill="#9A9490" stroke="#6E6A66" stroke-width="3" stroke-linejoin="round"/>
    <path d="M46 40 q16 2 22 14 q6 12 2 20 l-8 2 q4 -18 -16 -36z" fill="#96A4B2" opacity="0.45"/>
    <path d="M34 52 q10 -8 20 -2" fill="none" stroke="#7E7A76" stroke-width="3" stroke-linecap="round"/>
    <ellipse cx="36" cy="48" rx="9" ry="5" fill="#fff" opacity="0.28"/>
    <path d="M30 62 q5 -3 9 1 M44 66 q4 -3 8 0" fill="none" stroke="#7E7A76" stroke-width="2" stroke-linecap="round" opacity="0.7"/>
    <circle cx="66" cy="46" r="3" fill="#4CAF50" opacity="0.8"/><circle cx="72" cy="52" r="2.2" fill="#4CAF50" opacity="0.6"/></g>`),

  سکه: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="26" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <circle cx="50" cy="50" r="32" fill="#E8B84B" stroke="#B8863A" stroke-width="3.5"/>
    <path d="M26 40 a32 32 0 0 1 30 -21 q-16 6 -22 21 q-5 13 -8 22z" fill="#D69A1E" opacity="0.4"/>
    ...
    <ellipse cx="38" cy="36" rx="8" ry="5" fill="#fff" opacity="0.30" transform="rotate(-32 38 36)"/>
    <circle cx="76" cy="28" r="2.4" fill="#FBE6A2"/><circle cx="24" cy="72" r="2" fill="#FBE6A2"/></g>`),

  قاشق: () =>
    svg(`<g><ellipse cx="50" cy="92" rx="22" ry="4.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 86 v-34" stroke="#6F7A82" stroke-width="13" stroke-linecap="round"/>
    <path d="M50 86 v-34" stroke="#C9CFD4" stroke-width="8" stroke-linecap="round"/>
    <ellipse cx="50" cy="32" rx="21" ry="25" fill="#C9CFD4" stroke="#6F7A82" stroke-width="3.2"/>
    <ellipse cx="50" cy="33" rx="14" ry="17" fill="#9FA9B0"/>
    <ellipse cx="45" cy="25" rx="5" ry="8" fill="#EDF1F4"/>
    <path d="M55 22 q4 8 2 16" fill="none" stroke="#7FD1E8" stroke-width="3" stroke-linecap="round" opacity="0.8"/>
    <ellipse cx="46" cy="60" rx="2.6" ry="7" fill="#fff" opacity="0.28"/></g>`),
  ...
  نان: () =>
    svg(`<g><ellipse cx="50" cy="84" rx="34" ry="6" fill="#B9B0A0" opacity="0.28"/>
    <ellipse cx="50" cy="56" rx="35" ry="25" fill="#E0A94B" stroke="#B8863A" stroke-width="2.5"/>
    <path d="M15 58 a35 23 0 0 0 70 0 a35 10 0 0 1 -70 0z" fill="#C05A10" opacity="0.5"/>
    <ellipse cx="50" cy="50" rx="27" ry="17" fill="#F0C377"/>
    <ellipse cx="42" cy="42" rx="9" ry="5" fill="#fff" opacity="0.28"/>
    <circle cx="38" cy="48" r="2.4" fill="#B8863A"/>
    <circle cx="52" cy="44" r="2.4" fill="#B8863A"/>
    <circle cx="60" cy="54" r="2.4" fill="#B8863A"/>
    <circle cx="44" cy="58" r="2.4" fill="#B8863A"/></g>`),
  ...
  شیر: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="25" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M30 34 h40 v46 a6 6 0 0 1 -6 6 h-28 a6 6 0 0 1 -6 -6z"
    ...
    <ellipse cx="42" cy="56" rx="7" ry="4" fill="#fff" opacity="0.28"/>
    <circle cx="50" cy="62" r="7.5" fill="#FFF"/>
    <path d="M45.5 62 q4.5 -5.5 9 0 q-4.5 5.5 -9 0z" fill="#6FB2D2"/>
    <path d="M34 70 h32" stroke="#4A90B8" stroke-width="2" opacity="0.6"/>
    <circle cx="27" cy="22" r="2.2" fill="#FBE6A2"/><circle cx="74" cy="20" r="1.8" fill="#FBE6A2"/></g>`),

  ماست: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="4.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M26 40 h48 l-5 42 a5 5 0 0 1 -5 4 h-28 a5 5 0 0 1 -5 -4z"
      fill="#FBFBF8" stroke="#A9B2B8" stroke-width="3.2" stroke-linejoin="round"/>
    ...
    <ellipse cx="44" cy="38.6" rx="6" ry="2" fill="#fff" opacity="0.28"/>
    <path d="M40 58 h20 M38 68 h24" stroke="#C6D0D6" stroke-width="3.2" stroke-linecap="round"/>
    <ellipse cx="40" cy="56" rx="4" ry="9" fill="#fff" opacity="0.28"/>
    <circle cx="72" cy="52" r="2" fill="#D69A1E" opacity="0.8"/><circle cx="27" cy="64" r="1.8" fill="#D69A1E" opacity="0.8"/></g>`),

  موم: () =>
    svg(`<g><ellipse cx="50" cy="82" rx="30" ry="5.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 16 l26 15 v30 l-26 15 l-26 -15 v-30z"
    ...
    <path d="M50 54 l9 5 v10 l-9 5 l-9 -5 v-10z" fill="#D69A1E" opacity="0.55"/>
    <path d="M50 16 l-26 15 v30 l8 5 v-30 l22 -13z" fill="#F7D779" opacity=".85"/>
    <ellipse cx="41" cy="36" rx="6" ry="4" fill="#fff" opacity="0.28" transform="rotate(-26 41 36)"/></g>`),
  ...
  شیشه: () =>
    svg(`<g><ellipse cx="50" cy="80" rx="32" ry="5.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M24 26 h52 v48 h-52z" fill="#DCF0FA" stroke="#7FBBD6"
    ...
    <path d="M76 26 l8 -6 v48 l-8 6z" fill="#C4E4F2" stroke="#7FBBD6"
      stroke-width="3" stroke-linejoin="round"/>
    <ellipse cx="38" cy="38" rx="7" ry="4.5" fill="#fff" opacity="0.28" transform="rotate(-24 38 38)"/>
    <path d="M18 20 l3 -4 M84 18 l-3 -4" stroke="#7FD1E8" stroke-width="2.4" stroke-linecap="round"/>
    <circle cx="90" cy="34" r="1.8" fill="#FBE6A2"/></g>`),

  شکوفه: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="22" ry="4.5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 60 v26" stroke="#8B5E3C" stroke-width="4" stroke-linecap="round"/>
    ...
    <ellipse cx="46" cy="30" rx="3.4" ry="6" fill="#fff" opacity="0.28"/>
    <circle cx="50" cy="43" r="6" fill="#F4B942"/>
    <circle cx="50" cy="43" r="2.2" fill="#D69A1E"/>
    <path d="M80 24 q5 4 3 9 q-6 -1 -6 -7 q0 -3 3 -2z" fill="#F7CBD8" stroke="#E3A8BA" stroke-width="1.6"/>
    <path d="M80 36 q-2 4 0 6" fill="none" stroke="#E3A8BA" stroke-width="1.4" opacity="0.7"/></g>`),
  ...
  بادام: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="24" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 14 C74 34 80 62 50 86 C20 62 26 34 50 14z" fill="#D9A86C" stroke="#A9793F" stroke-width="3"/>
    <path d="M50 24 C61 42 61 66 50 78" fill="none" stroke="#A9793F" stroke-width="2.6" stroke-linecap="round"/>
    <ellipse cx="42" cy="38" rx="5" ry="10" fill="#fff" opacity="0.28" transform="rotate(18 42 38)"/>
    <path d="M42 26 q-3 6 -2 12 M58 30 q3 8 1 16" fill="none" stroke="#C05A10" stroke-width="1.6" opacity="0.5"/>
    <path d="M50 78 q2 6 0 8" fill="none" stroke="#A9793F" stroke-width="2" stroke-linecap="round"/></g>`),

  سبد: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="30" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M28 40 a22 20 0 0 1 44 0" fill="none" stroke="#8B6F47" stroke-width="5" stroke-linecap="round"/>
    <path d="M18 42 h64 l-9 44 h-46z" fill="#C89B5A" stroke="#8B6F47" stroke-width="3" stroke-linejoin="round"/>
    <path d="M26 58 h48" stroke="#D69A1E" stroke-width="2.4" opacity="0.7"/>
    <path d="M29 72 h42" stroke="#8B6F47" stroke-width="2.4"/>
    <path d="M34 46 l4 38 M50 46 v38 M66 46 l-4 38" stroke="#8B6F47" stroke-width="2.4"/>
    <ellipse cx="40" cy="50" rx="8" ry="4" fill="#fff" opacity="0.28"/>
    <path d="M22 44 q6 30 12 38" fill="none" stroke="#A87B3A" stroke-width="1.8" opacity="0.6"/></g>`),

  توت: () =>
    svg(`<g><ellipse cx="50" cy="86" rx="24" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M50 34 v-18" stroke="#4E7A32" stroke-width="3.4" stroke-linecap="round"/>
    ...
    <circle cx="62" cy="54" r="9.6" fill="#C1352B"/>
    <ellipse cx="44" cy="50" rx="3.4" ry="4.6" fill="#fff" opacity="0.28"/>
    <ellipse cx="57" cy="64" rx="3" ry="4" fill="#fff" opacity="0.28"/></g>`),

  اتو: () =>
    svg(`<g><ellipse cx="50" cy="87" rx="32" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M14 74 h72 q2 -18 -16 -24 h-32 q-20 4 -24 24z" fill="#B9C3CC" stroke="#7B8794" stroke-width="3" stroke-linejoin="round"/>
    <path d="M12 74 h76 v9 h-76z" fill="#7B8794"/>
    <path d="M12 77 h76" stroke="#96A4B2" stroke-width="2" stroke-linecap="round"/>
    <path d="M34 50 q16 -22 34 -8" fill="none" stroke="#4A5560" stroke-width="7" stroke-linecap="round"/>
    <ellipse cx="30" cy="60" rx="9" ry="5" fill="#fff" opacity="0.28"/>
    <circle cx="26" cy="66" r="3.4" fill="#E4572E"/><circle cx="26" cy="66" r="1.4" fill="#8E1C1C"/>
    <path d="M36 30 q-3 -6 2 -8 M48 24 q-2 -6 3 -7" fill="none" stroke="#7FD1E8" stroke-width="2.8" stroke-linecap="round"/></g>`),

  سوت: () =>
    svg(`<g><ellipse cx="50" cy="80" rx="28" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <path d="M22 40 h44 a16 16 0 0 1 0 32 h-44 a4 4 0 0 1 -4 -4 v-24 a4 4 0 0 1 4 -4z"
      fill="#C9CFD4" stroke="#7B8794" stroke-width="3" stroke-linejoin="round"/>
    <ellipse cx="38" cy="48" rx="10" ry="5" fill="#fff" opacity="0.28"/>
    <circle cx="62" cy="56" r="6" fill="#7B8794"/>
    <circle cx="62" cy="56" r="2.4" fill="#4A5560"/>
    <path d="M18 46 h-8" stroke="#7B8794" stroke-width="5" stroke-linecap="round"/>
    <path d="M74 34 q10 -6 14 -14 M80 50 h10 M74 68 q10 6 14 14" fill="none" stroke="#E4572E" stroke-width="4" stroke-linecap="round"/></g>`),

  مار: () =>
    svg(`<g><ellipse cx="50" cy="90" rx="28" ry="5" fill="#B9B0A0" opacity="0.28"/>
    ...
    <ellipse cx="24" cy="70" rx="6" ry="3.6" fill="#fff" opacity="0.28" transform="rotate(-18 24 70)"/>
    <circle cx="56" cy="30" r="9" fill="#4CAF50"/>
    <ellipse cx="52.5" cy="26.5" rx="3" ry="2.2" fill="#fff" opacity="0.28"/>
    <circle cx="59" cy="27" r="2.6" fill="#2D2A32"/>
    <path d="M65 31 h10 l-5 4 M70 35 l5 4" fill="none" stroke="#E4572E" stroke-width="2.6" stroke-linecap="round"/></g>`),

  میز: () =>
    svg(`<g><ellipse cx="50" cy="88" rx="32" ry="5" fill="#B9B0A0" opacity="0.28"/>
    <rect x="12" y="38" width="76" height="11" rx="4" fill="#C89B5A" stroke="#8B6F47" stroke-width="2.6"/>
    <path d="M20 43.5 h56" stroke="#A87B3A" stroke-width="1.8" stroke-linecap="round" opacity="0.7"/>
    <ellipse cx="24" cy="41.5" rx="8" ry="2.6" fill="#fff" opacity="0.28"/>
    <path d="M22 49 v34 M78 49 v34" stroke="#8B6F47" stroke-width="8" stroke-linecap="round"/>
    <path d="M26 52 v28 M74 52 v28" stroke="#A87B3A" stroke-width="2" opacity="0.6"/>
    <circle cx="60" cy="43.5" r="1.6" fill="#A87B3A" opacity="0.8"/></g>`),

  باران: () =>
    svg(`<g><ellipse cx="50" cy="95" rx="30" ry="4" fill="#B9B0A0" opacity="0.25"/>
    <path d="M30 46 a15 15 0 0 1 29 -6 a13 13 0 0 1 13 20 h-42 a12 12 0 0 1 0 -14z"
    ...
    <ellipse cx="38" cy="34" rx="7" ry="4" fill="#fff" opacity="0.28"/>
    ...
    <path d="M28 94 q4 -4 8 0 M62 94 q4 -4 8 0" fill="none" stroke="#7FD1E8" stroke-width="2.2" stroke-linecap="round"/></g>`),
  ...
  شمع: () =>
    svg(`<rect x="34" y="36" width="32" height="44" rx="5" fill="#EBD49E" stroke="#8A6E38" stroke-width="3.2"/>
    <path d="M37 39 h9 v38 h-9z" fill="#F9EFD3"/>
    <path d="M57 39 h6 v38 h-6z" fill="#CBAE6A"/>
    <rect x="26" y="78" width="48" height="12" rx="5" fill="#8A6E38" stroke="#5E4A22" stroke-width="2.8"/>
    <path d="M50 36 v-7" stroke="#3E3A33" stroke-width="3.4" stroke-linecap="round"/>
    <path d="M50 6 q12 14 0 24 q-12 -10 0 -24z" fill="#F4B942" stroke="#C98A12" stroke-width="2.4"/>
    <path d="M50 15 q6 8 0 13 q-6 -5 0 -13z" fill="#E4572E"/>`),
...
export const SCENES = {
  ...
  کتاب‌خواندن: () =>
    svg(`<circle cx="50" cy="24" r="14" fill="#F5D3B5" stroke="#C98F62" stroke-width="2.6"/>
    <path d="M36 21 a14 14 0 0 1 28 0z" fill="#6B4A2F"/>
    <circle cx="44" cy="26" r="2.6" fill="#2B2A33"/>
    <circle cx="56" cy="26" r="2.6" fill="#2B2A33"/>
    <path d="M44 32 q6 5 12 0" fill="none" stroke="#2B2A33" stroke-width="2.4" stroke-linecap="round"/>
    <path d="M14 50 q34 -12 36 4 q2 -16 36 -4 v28 q-34 -12 -36 4 q-2 -16 -36 -4z" fill="#2F6E8C" stroke="#1D4A60" stroke-width="3" stroke-linejoin="round"/>
    <path d="M19 54 q28 -9 29 4 v21 q-1 -13 -29 -4z" fill="#F7F2E8"/>
    <path d="M81 54 q-28 -9 -29 4 v21 q1 -13 29 -4z" fill="#E4DBCA"/>
    <path d="M25 61 h17 M25 68 h15 M58 61 h17 M60 68 h15" stroke="#9C8F7C" stroke-width="2.4" stroke-linecap="round"/>`),

  نفس‌عمیق: () =>
    svg(`<circle cx="50" cy="50" r="38" fill="none" stroke="#8FC4E0" stroke-width="4" stroke-dasharray="11 9" stroke-linecap="round"/>
    <circle cx="50" cy="50" r="28" fill="none" stroke="#4E9CC4" stroke-width="4.5"/>
    <circle cx="50" cy="50" r="20" fill="#F5D3B5" stroke="#C98F62" stroke-width="2.8"/>
    <path d="M39 46 q5 -5 10 0" fill="none" stroke="#2B2A33" stroke-width="2.8" stroke-linecap="round"/>
    <path d="M53 46 q5 -5 10 0" fill="none" stroke="#2B2A33" stroke-width="2.8" stroke-linecap="round"/>
    <ellipse cx="50" cy="59" rx="6" ry="5" fill="#2B2A33"/>`),
...
export const HAZARDS = {
  ...
  چاقو: () =>
    svg(`<path d="M18 18 q32 6 44 32 l-11 11 q-21 -23 -33 -43z" fill="#C9D2DA" stroke="#69747E" stroke-width="3" stroke-linejoin="round"/>
    <path d="M24 24 q25 7 35 27" fill="none" stroke="#F2F6F9" stroke-width="4.5" stroke-linecap="round"/>
    <path d="M53 61 l25 25" stroke="#5A3670" stroke-width="19" stroke-linecap="round"/>
    <path d="M53 61 l25 25" stroke="#8A57A6" stroke-width="12" stroke-linecap="round"/>
    <circle cx="62" cy="70" r="2.6" fill="#4A2C5C"/>
    <circle cx="71" cy="79" r="2.6" fill="#4A2C5C"/>`),
