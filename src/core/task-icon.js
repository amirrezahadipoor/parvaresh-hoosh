...
const KIND_ACTION = Object.freeze({
  ...
  // قافیه «جفت آهنگی» است؛ نزدیک‌ترین فعلِ موجود «جفت پیدا کن» است.
  'rhyme-pick': ACTIONS.match,
  'first-sound': ACTIONS.listen,
  'word-pic': ACTIONS.pick,
  'pic-word': ACTIONS.pick,
  'word-build': ACTIONS.order,
  'which-sound': ACTIONS.blend,
  doubles: ACTIONS.add,
  'fact-family': ACTIONS.add,
  'count-tens': ACTIONS.count,
  'and-rule': ACTIONS.pick,
  'true-false': ACTIONS.pick,
  position: ACTIONS.pick,
  'wh-question': ACTIONS.pick,
  'passage-read': ACTIONS.pick,
  'passage-order': ACTIONS.order,
  ...
  'push-pull': ACTIONS.pick,
  'made-of': ACTIONS.pick,
  'light-shadow': ACTIONS.pick,
