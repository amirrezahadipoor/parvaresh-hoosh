...
export const LIFE_LESSONS = [
  ...
  },
  {
    ...
    domain: 'life',
    order: 21,
    title: 'دوستی و همکاری',
    goal: 'کودک می‌فهمد نوبت گرفتن و کمک کردن، دوستی می‌سازد.',
    minutes: 6,
    parentNote:
      '«نوبت» انتزاعی‌ترین مهارت اجتماعی این سن است. با بازی‌های نوبتی ساده (مار و پله) تمرینش کنید، نه با نصیحت.',
    reviewDays: [1, 3, 7],
    rounds: [
      { kind: 'good-habit', prompt: 'کدام کار درست است؟' },
      { kind: 'problem-solve', prompt: 'چه کار کنیم؟' },
      { kind: 'feel-face', prompt: 'چه حسی دارد؟' },
      { kind: 'name-face', prompt: 'اسم این حس چیست؟' },
      { kind: 'good-habit', prompt: 'کدام کار درست است؟' },
    ],
  },
  {
    ...
    domain: 'life',
    order: 22,
    title: 'وقتی عصبانی می‌شوم',
    goal: 'کودک راه‌های آرام‌شدن را می‌شناسد و انتخاب می‌کند.',
    minutes: 6,
    parentNote:
      'کودک عصبانی نمی‌تواند فکر کند — اول باید آرام شود. نفس عمیق را در حال آرامش تمرین کنید، نه وسط دعوا.',
    reviewDays: [1, 3, 7],
    rounds: [
      { kind: 'feeling-fix', prompt: 'چه کار کنیم؟' },
      { kind: 'feeling-fix', prompt: 'چه کار کنیم؟' },
      { kind: 'feel-face', prompt: 'چه حسی دارد؟' },
      { kind: 'problem-solve', prompt: 'چه کار کنیم؟' },
      { kind: 'name-face', prompt: 'اسم این حس چیست؟' },
  ...
  },
  {
    ...
    domain: 'life',
    order: 23,
    title: 'ایمنی بیرون از خانه',
    goal: 'کودک خطرهای بیرون را می‌شناسد و واکنش درست را می‌داند.',
    minutes: 6,
    parentNote:
      'شمارهٔ تماس خودتان را با کودک تمرین کنید تا از حفظ بگوید. این تنها چیزی است که در گم‌شدن واقعاً کمک می‌کند.',
    reviewDays: [1, 3, 7],
    rounds: [
      { kind: 'safe-pick', prompt: 'کدام بی‌خطر است؟' },
      { kind: 'safety-order', prompt: 'به ترتیب بچین' },
      { kind: 'safe-pick', prompt: 'کدام بی‌خطر است؟' },
      { kind: 'problem-solve', prompt: 'چه کار کنیم؟' },
      { kind: 'good-habit', prompt: 'کدام کار درست است؟' },
  ...
  },
  {
    ...
    order: 24,
    title: 'حس دیگران ۲',
    goal: 'کودک از روی چهره و موقعیت، حس دیگران را حدس می‌زند.',
    minutes: 6,
    parentNote:
      'همدلی با «تشخیص» شروع می‌شود نه با «احساس». وقتی کسی ناراحت است، بپرسید «به‌نظرت چه حسی دارد؟»',
    reviewDays: [1, 3, 7],
    rounds: [
      { kind: 'feel-face', prompt: 'چه حسی دارد؟' },
      { kind: 'name-face', prompt: 'اسم این حس چیست؟' },
  ...
  },
  {
    ...
    domain: 'life',
    order: 25,
    title: 'مهارت‌های پایانی ۲',
    goal: 'کودک همهٔ مهارت‌های زندگی را در یک آزمون پایانی می‌آزماید.',
    minutes: 6,
    parentNote:
      'آخرین درس مهارت زندگی. این مهارت‌ها با یک بار بازی جا نمی‌افتند — هر چند وقت یک بار برگردید.',
    reviewDays: [1, 3, 7],
    rounds: [
      { kind: 'name-face', prompt: 'اسم این حس چیست؟' },
      { kind: 'feeling-fix', prompt: 'چه کار کنیم؟' },
